...
_METRIC_REQUIRED_COMMANDS: Dict[str, Tuple[str, ...]] = {
    ...
    "local.cpu.load_5m": ("bash", "cat", "nproc"),
    "local.cpu.load_15m": ("bash", "cat", "nproc"),
    ...
    "local.nginx.process.present": ("bash", "ps", "grep"),
    "local.nginx.version": ("bash", "ps", "grep", "head"),
    ...
    "local.keepalived.vip.access": ("bash", "ps", "grep", "head", "sed", "awk", "curl"),
    "local.keepalived.config.baseline": ("bash", "ps", "grep", "head", "sed"),
    "local.keepalived.healthcheck.script": ("bash", "ps", "grep", "head", "sed", "awk", "ls"),
    "local.keepalived.error_log.key_evidence": ("bash", "ps", "grep", "head", "tail"),
    "local.keepalived.capability.stability": ("bash", "ps", "grep", "head", "getcap", "systemctl", "tail"),
    "local.elasticsearch.process.present": ("bash", "ps", "grep"),
    "local.elasticsearch.version": ("bash", "ps", "grep", "head", "sed", "curl"),
    "local.elasticsearch.cluster.health": ("bash", "ps", "grep", "head", "sed", "curl"),
    "local.elasticsearch.nodes.online": ("bash", "ps", "grep", "head", "sed", "curl"),
    "local.elasticsearch.nodes.cpu": ("bash", "ps", "grep", "head", "sed", "curl"),
    "local.elasticsearch.nodes.memory": ("bash", "ps", "grep", "head", "sed", "curl"),
    "local.elasticsearch.nodes.disk": ("bash", "ps", "grep", "head", "sed", "curl"),
    "local.elasticsearch.disk.watermark": ("bash", "ps", "grep", "head", "sed", "curl"),
    "local.elasticsearch.shards.unassigned": ("bash", "ps", "grep", "head", "sed", "curl"),
    "local.elasticsearch.service.port": ("bash", "ps", "grep", "head", "sed", "ss"),
    "local.elasticsearch.heap.gc": ("bash", "ps", "grep", "head", "sed", "curl", "tail"),
    "local.elasticsearch.thread_pool.rejected": ("bash", "ps", "grep", "head", "sed", "curl"),
    "local.elasticsearch.cluster.settings": ("bash", "ps", "grep", "head", "sed", "curl"),
    "local.elasticsearch.discovery.config": ("bash", "ps", "grep", "head", "sed"),
    "local.elasticsearch.indices.health": ("bash", "ps", "grep", "head", "sed", "curl"),
    "local.elasticsearch.slowlog.key_evidence": ("bash", "ps", "grep", "head", "sed", "ls", "tail"),
    "local.elasticsearch.security.accounts": ("bash", "ps", "grep", "head", "sed", "curl"),
    "local.elasticsearch.certificate.validity": ("bash", "ps", "grep", "head", "sed", "openssl"),
    "local.elasticsearch.snapshot.repository": ("bash", "ps", "grep", "head", "sed", "curl"),
    "local.elasticsearch.system.parameters": ("bash", "ps", "grep", "head", "sed", "cat", "free", "su"),
}
