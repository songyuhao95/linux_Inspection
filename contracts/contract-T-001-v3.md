```json
{
  ...
  "contract_id": "contract-T-001-v3",
  "contract_sha256": "sha256:a5c8316243f6db40df78704f218b8de63fc90680f60cac12cda83e8eda133196",
  "contract_version": 3,
  "cost_required": false,
  "deliverables": [
    {
  ...
  "idempotency_key": "run-20260814-001:T-001:v3",
  "input_artifacts": [
    {
    ...
    },
    {
      ...
      "version": "2a6afff24a97657dcb645b1597d1e374da0a2b68"
    }
  ],
...
1. 先确认工作树基线包含提交 `2a6afff24a97657dcb645b1597d1e374da0a2b68`；若隔离 worktree 基于更旧的 `origin/main`，只允许执行 `git merge --ff-only 2a6afff24a97657dcb645b1597d1e374da0a2b68` 快进到批准基线。
